...
public interface EmployeRepository extends JpaRepository<Employee, Integer> {
    ...
    @Query(value = "select * from employee where employe_ID like %:keyword% or name like %:keyword% or email like %:keyword% or gender like %:keyword% or addres like %:keyword% ", nativeQuery = true)
